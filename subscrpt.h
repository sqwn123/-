//subscrpt.h ¿ªÊ¼
// Template Numerical Toolkit (TNT) for Linear Algebra BY R. Pozo
// Applied and Computational Mathematics Division National Institute of Standards and Technology

#ifndef SUBSCRPT_H
#define SUBSCRPT_H
//---------------------------------------------------------------------
// This definition describes the default TNT data type used for  indexing into TNT matrices and vectors.  The data //type should be wide enough to index into large arrays.  It defaults to an "int", but can be overriden at compile time //redefining TNT_SUBSCRIPT_TYPE, e.g.
